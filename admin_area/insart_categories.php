<?php
  ...
  if(isset($_POST['insert_cat'])){
    ...
    $insert_guery ="insert into `categories` (categories_title) values ('$categories_title')";
...
<div class="input-group w-10 mb-2 m-auto">
       <input type="submit" class="bg-info border-0 p-2 my-3" name="insert_cat" value="Insaert Categories">
</div>
</form>
