...
<table class="table table-bordered mt-5">
    ...
    <?php
        ...
        <tr class="text-center">
            ...
            <td><a href='index.php?delete_brand=<?php echo $brands_id ?>' type="button" 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary"><a href='index.php?delete_brand=<?php echo $brands_id ?>'
