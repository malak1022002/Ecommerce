...
<div class="row">
    <div class="col-md-2">
        <ul class="navbar-nav bg-secondary text-center" id="first">
           ...
           <li class="nav-item">
            <a class="nav-link text-light" href="profile.php?delet_account">Delete Account</a>
           </li>
           <li class="nav-item">
