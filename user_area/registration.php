        ...
        <div class="row d-flex align-items-center justify-content-center">
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                        <label for="conf_user_passwoed" class="form-label">Confirm Password</label>
                        <input type="password" id="conf_user_passwoed" class="form-control"
                        placeholder="confirm password" autocomplete="off"
                        required="required" name="conf_user_passwoed">
                    </div>
                    <!-- Address feield -->
                    <div class="form-outline mb-4">
                    ...
                    <div class="mt-4 pt-2">
                        <input type="submit" value="register" class="bg-info border-0 
                        py-2 px-3" name="user_register">
...
$hash_password = password_hash($user_passwoed,PASSWORD_DEFAULT);
$conf_user_passwoed = $_POST['conf_user_passwoed'];
...
}else if($user_passwoed!=$conf_user_passwoed){
    echo "<script>alert('Password do not match')</script>";
}else{
    //insert query
move_uploaded_file($user_image_tmp, "./user_images/$user_image");
$insert_query = "INSERT INTO `user_table` (username, user_email, user_password, 
user_image, user_ip, user_address, user_mobile) VALUE ('$user_username', 
...
if($rows_count>0){
    $_SESSION['username']=$user_usernam;
